...
HOW SHOULD THIS LOOK AT THE END 

* This is a test driven program 
    WHY: Because in the beginning of programming, you break down the parts you need to test to make sure your logic is working.         
         As you go thru the code, there is a clear path of testing so that the final product comes out correctly with less bugs 
    
    DISADVANTAGES: It is difficult because when you start you don't have things to test, so it takes a bit of upfront work

* WHAT IT LOOKS LIKE IN THE END
    Output is generated by the ErrorContext h and cpp files 
    Point tests makes the calls to error context objects
    output is a bunch of points
    I am coding in area and point